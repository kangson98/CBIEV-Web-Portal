...
class CreateMRManagerRecommendationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mr_manager_recommendations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mr_manager_recommendations');
    }
}
