...
class CreateIRDirectorApprovalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ir_director_approvals', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ir_director_approvals');
    }
}
