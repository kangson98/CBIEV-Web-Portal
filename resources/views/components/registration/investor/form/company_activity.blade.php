...
<div class="form-group row">
    <label for="companyBusinessClassification" class="col-sm-3 col-form-label">Business Classification</label>
    <div class="col-sm-9">
        <input type="text" name="companyBusinessClassification" id="companyBusinessClassification" class="form-control">
    </div>
</div>
<div class="form-group row">
    <label for="companyBusinessDesc" class="col-sm-3 col-form-label">Brief Description of Business</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="mentorCategory" class="col-sm-6 col-form-label">
        ...
        if yes, you will need to attend at least one session every month.
    </label>
    <div class="col-sm-6">
