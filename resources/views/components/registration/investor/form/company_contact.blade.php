...
<div class="form-row">
    <div class="form-group col-md-6">
        <label for="companyTel" class="col-form-label">Tel No<span style="color:red">*</span></label>
        <div class="">
            <input type="text" name="companyTel" id="companyTel" class="form-control">
        </div>
    </div>
    <div class="form-group col-md-6">
        <label for="companyFax" class="col-sm-3 col-form-label">Fax No<span style="color:red">*</span></label>
        <div class="">
            <input type="text" name="companyFax" id="companyFax" class="form-control">
        </div>
    </div>
</div>
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        <div class="">
            <input type="text" name="companyHP" id="companyHP" class="form-control">
        </div>
    </div>
    <div class="form-group col-md-6">
