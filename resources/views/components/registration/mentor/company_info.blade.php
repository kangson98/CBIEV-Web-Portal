...
<div class="form-group row">
    <label for="mentorCompanyName" class="col-sm-2 col-form-label">Company Name</label>
    <div class="col-sm-10">
...
<div class="form-group row">
    <label for="mentorPosition" class="col-sm-2 col-form-label">Position</label>
    <div class="col-sm-10">
...
<div class="form-group row">
    <label for="mentorDepartment" class="col-sm-2 col-form-label">Center/Department/Faculty</label>
    <div class="col-sm-10">
...
<div class="form-group row">
    <label for="mentorCompanyEmail" class="col-sm-2 col-form-label">UC Email/Official Email</label>
    <div class="col-sm-10">
