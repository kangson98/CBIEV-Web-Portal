...
<div class="container" >
    <div class="card">
        ...
        <div class="card-body">
        <form action="{{route('mentor.approval.post')}}" method="post" >
            @csrf
            <input type="hidden" name="appID" value="{{Crypt::encrypt($recID)}}">
                <div class="form-row">
                    <div class="form-group col-sm-4">Do you approve this mentor registration?<span style="color:red"> *</span></div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-10">
                        <label for="approvalReason">Approval Reason</label><span style="color:red"> *</span>
                        <textarea class="form-control" id="approvalReason" name="approvalReason" cols="30" rows="10" value="">{{$approvalReason}}</textarea>
                        @if ($errors->has('approvalReason'))
                        <div class="alert alert-danger" role="alert">
